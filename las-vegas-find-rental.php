<?php
	if (isset($_POST["submit"])) {
		...
		$phone = $_POST['phone'];
		$pets = $_POST['pets'];
		$maxleaseprice = $_POST['maxleaseprice'];
		$bedrooms = $_POST['bedrooms'];
		$bathrooms = $_POST['bathrooms'];
		$comments = $_POST['comments'];
		$from = 'Rental Information Request';
		$to = 'harrisonnv@gmail.com'; 
		$subject = "Rental Information Request from $name";
		
		$body ="From: $name\nE-Mail: $email\nPhone Number: $phone\nPets: $pets\nMax Lease Price: $maxleaseprice\nBedrooms: $bedrooms\nBathrooms: $bathrooms\nComments: $comments";
...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Fill out this short form and I will begin emailing rental listings that match your search criteria.">
		<meta name="author" content="Suzanne Harrison">
		<meta name="keywords" content="Rental Search, Free Home Analysis, Las Vegas, Las Vegas Valley, Clark County, City of Las Vegas, City of North Las Vegas, City of Henderson, Boulder City, Nellis Air Force Base, Spring Mountains, Mount Charleston, Southern Nevada, Real Estate, Broker, Selling, 1031 Exchange, Short Sale, Foreclosure, Sell, Buying, Buy, Renting, Rent, MLS, Multiple Listing Service, Mortgate, Calculator, Maps, Reference Maps, Weather, Weather Forecast, Current Conditions, Personal Weather Station">
		<link rel="icon" href="images/favicon.ico">
		
		<!-- website title -->
		<title>Las Vegas Rental Information Request Form</title>
			...
			<div class="container-fluid">
				<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="col-xs-12 col-sm-10" id="MainDiv">
						<img src="images/NVH_rental_listings.png" class="center-block img-responsive" alt="Las Vegas Valley News">
						...
						<div>
							<br>
							<p class="text-center">
							Submit your information and rental criteria using the form below. I look forward to working with you!
							</p>
						</div>
						
						<div class="panel panel-primary">
							<div class="panel-heading text-center">
								<h4>Rental Search Form</h4>
							</div>
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" action="las-vegas-find-rental.php">
									...
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Do you have pets?</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pets" name="pets" placeholder="Pets - Yes or No" value="<?php echo htmlspecialchars($_POST['pets']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Max Lease Price</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="maxleaseprice" name="maxleaseprice" placeholder="example: $1200" value="<?php echo htmlspecialchars($_POST['maxleaseprice']); ?>">
										</div>
									</div>
									<div class="form-group">
