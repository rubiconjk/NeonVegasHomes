<?php
	if (isset($_POST["submit"])) {
		...
		$phone = $_POST['phone'];
		$pool = $_POST['pool'];
		$maxsaleprice = $_POST['maxsaleprice'];
		$minsaleprice = $_POST['minsaleprice'];
		$bedrooms = $_POST['bedrooms'];
		$bathrooms = $_POST['bathrooms'];
		$comments = $_POST['comments'];
		$from = 'Home Sales Information Request';
		$to = 'HarrisonNV@gmail.com'; 
		$subject = "Home Sales Information Request from $name";
...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Fill out this short form and I will begin emailing sales listings that match your search criteria.">
		<meta name="author" content="Suzanne Harrison">
		<meta name="keywords" content="Property Search, Free Home Analysis, Las Vegas, Las Vegas Valley, Clark County, City of Las Vegas, City of North Las Vegas, City of Henderson, Boulder City, Nellis Air Force Base, Spring Mountains, Mount Charleston, Southern Nevada, Real Estate, Broker, Selling, 1031 Exchange, Short Sale, Foreclosure, Sell, Buying, Buy, Renting, Rent, MLS, Multiple Listing Service, Mortgate, Calculator, Maps, Reference Maps, Weather, Weather Forecast, Current Conditions, Personal Weather Station">
		<link rel="icon" href="images/favicon.ico">
		
		<!-- website title -->
		<title>Las Vegas Home Sales Information Request Form</title>
				...
				<div class="row row-offcanvas row-offcanvas-left">
					...
					<div class="col-xs-6 col-sm-2 sidebar-offcanvas" id="sidebar" role="navigation">
						<ul class="nav nvh-list">
							...
							<li><a href="las-vegas-realtor-home-value-analysis.php" class="link-white">Home Analysis</a></li>
					...
					<div class="col-xs-12 col-sm-10" id="MainDiv">
						<img src="images/NVH_listings.png" class="center-block img-responsive" alt="Las Vegas Valley News">
						...
						<div>
							<br>
							<p class="text-center">
							Submit your information and search criteria using the form below. I look forward to working with you!
							</p>
						</div>
						
						<div class="panel panel-primary">
							<div class="panel-heading text-center">
								<h4>Home Sales Search Form</h4>
							</div>
							<div class="panel-body">
								<form class="form-horizontal" role="form" method="post" action="las-vegas-property-for-sale.php">
									...
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Home with a pool?</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="pool" name="pool" placeholder="Pool - Yes or No" value="<?php echo htmlspecialchars($_POST['pets']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Maximum Sales Price</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="maxsalesprice" name="maxsaleprice" placeholder="example: $300,000" value="<?php echo htmlspecialchars($_POST['maxleaseprice']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Minimum Sales Price</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="minsalesprice" name="minsaleprice" placeholder="example: $200,000" value="<?php echo htmlspecialchars($_POST['maxleaseprice']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label"># of Bedrooms</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="bedrooms" name="bedrooms" placeholder="How many bedrooms?" value="<?php echo htmlspecialchars($_POST['bedrooms']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label"># of Bathrooms</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="bathrooms" name="bathrooms" placeholder="How many bathrooms?" value="<?php echo htmlspecialchars($_POST['bathrooms']); ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="phone" class="col-sm-2 control-label">Comments</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" id="comments" name="comments" placeholder="Enter any comments or special requests" value="<?php echo htmlspecialchars($_POST['comments']); ?>">
										</div>
									</div>
